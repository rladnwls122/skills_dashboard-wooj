...
const avg = summarize(
  { key: "targetResponseTime", label: "TRT", unit: "s", stat: "Average", points: Array.from({ length: 8 }, (_, i) => ({ t: now + i * 60_000, v: 0.4 })) },
...
const empty = summarize({ key: "http4xx", label: "4XX", unit: "req/min", stat: "Sum", points: [] }, resolveWindow({ windowMin: 60, intervalMin: 1 }, now));
