...
//
// backend/internal/config/dotenv.go parses the same grammar and does the same
// thing for the binary itself; keep the two in step.
...
function candidates(explicit) {
  ...
  // scripts/dotenv.mjs -> repository root.
...
function findClosingDouble(raw) {
 ...
 */
export function loadDotenv(explicitPath) {
